...
import com.example.my_quiz.QuizContract.*;
...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillQuestionsTable() {
        Question q1 = new Question("Cette fleur est", "Alstroemeria", "Amaryllis", "Canna", 1);
        addQuestion(q1);
        Question q2 = new Question("cette fleur est nomé", "Dahlia", "OEillet", "Narcisse", 2);
        addQuestion(q2);
        Question q3 = new Question("Cette fleur est appelé ", "Cyclamen", "Joy", "Hydrangée", 3);
        addQuestion(q3);
        Question q4 = new Question("devinez le nom de cette fleurs", "Arum d'Éthiopie", "Rose", "Fleurs de cactus", 2);
        addQuestion(q4);
        Question q5 = new Question("cette fleur est ", "chrysanthèmes", "Hibiscus", "Jasmine", 1);
        addQuestion(q5);
    }
